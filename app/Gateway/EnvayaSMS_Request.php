...
class EnvayaSMS_Request
{
   ...
   public function supports_json()
    ...
    public function supports_update_settings()
    {
   ...
   public function render_response($events = null /* optional array of EnvayaSMS_Event objects */) 
    {
        if ($this->supports_json())
        {
     ...
     * @return string
     */
    public function render_error_response($message)
    {
        if ($this->supports_json())
        {
